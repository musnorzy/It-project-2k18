...
который хочет исправить проблемы нашей страны. Для этого он сражается с "угнетателями" России, побеждая их, и когда все проблемы будут исправлены, игра будет пройдена. Все сражения будут в стили файтингов. 
